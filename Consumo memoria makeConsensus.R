...
simulazioni=simulate_gauss_mix(n_cells=1000, n_genes=150,
...
#7000
simulazioni=simulate_gauss_mix(n_cells=7000, n_genes=150,
                               k=ngruppi, x_mus = medie_x, 
                               x_sds = c(runif(ngruppi,0.1,1)), 
                               y_mus = medie_y, 
                               y_sds = c(runif(ngruppi,0.1,1)), 
...
#10000
simulazioni=simulate_gauss_mix(n_cells=10000, n_genes=150,
                               k=ngruppi, x_mus = medie_x, 
                               x_sds = c(runif(ngruppi,0.1,1)), 
                               y_mus = medie_y, 
                               y_sds = c(runif(ngruppi,0.1,1)), 
